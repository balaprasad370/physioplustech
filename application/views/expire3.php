			...
			<div class="span7 homeabout">
				...
				<h3>Practice management : </h3>
					<div class="row">
							 ...
							 <ul>
								<li>This is the best practice management tool for a clinic</li><br>
								<li>Send referral thanks letter to the physicians & other healthcare professionals instantly </li><br>
								<li>Send appointment remainders and exercise remainders to the patients </li><br>
								<li>Send bulk promotional sms to patients & staffs  </li><br>
								<li>Send birthday  greeting SMS automatically </li><br>
								<li>Send pending payment status for bills  </li><br>
								<li>Obtain income statement & income analysis automatically </li><br>
								<li>Graphical reperasation of patient visits </li>
							 </ul>
					</div>			
