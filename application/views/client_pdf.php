...
if($sta == 'private'){
	$chartDet = $CI->pdf_model->getprivatecharts($chart_no,$client_id);
} else {
	$chartDet = $CI->pdf_model->getcharts($chart_no,$client_id);
}
$clientDetails = $CI->pdf_model->editProfile($client_id);
?>
<table>
<tr>
