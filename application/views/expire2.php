			...
			<div class="span7 homeabout">
				...
				<h3>Invoice: </h3>
					<div class="row">
							 ...
							 <ul>
								<li>Make invoice per treatment session </li><br>
								<li>Automatically generate invoice from treatment protocol </li><br>
								<li>Make collective invoice (say for 10 days & deduct fees manually ) </li><br>
								<li>Make monthly invoice that can automatically deduct fees daily  </li><br>
								<li>Add advance & deduct from payment method  </li>
							 </ul>
					</div>	
