      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="row-fluid" id="draggable_portlets">
				<form name="ajaxform" id="ajaxform" action="<?php echo base_url().'patient/patient/edit_appointment' ?>" method="POST" class="form-horizontal" >
					   ...
					   <section class="panel">
							<div class="panel-body">
								<?php $this->db->select("start")->from('tbl_appointments');
									...
									<div class="col-lg-3">
										  <input type="text" name="app_date" data-date-format='DD/MM/YYYY' placeholder="<?php echo $row['appointment_from'] ?>" class="form-control datepicker" parsley-trigger="change" parsley-required="true" id="appointment_from">
                          			</div>
									<input type="hidden" value="<?php echo $row['appointment_id'] ?>" name="appointment_id" />
									<input type="hidden" value="<?php echo $row['appointment_from'] ?>" name="appointment_from" />
									</div></br></br>
									<div class="form-group">
									<label class="col-sm-5 control-label col-lg-2" > Time :</label>
									<div class="col-lg-3">
									<select class="form-control input-sm m-bot15" name="time" id="time">
                                             <option value="<?php echo date('g:i A',strtotime($row['start'])) ?>"><?php echo date('g:i A',strtotime($row['start'])) ?></option>
