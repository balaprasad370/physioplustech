                ...
                <div class="d-flex h-100 justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-md-8">
                        <a href="<?php echo base_url()?>"><center><img src="<?php echo base_url().'assets/images/logo new.png' ?>" style="width:162px; height:auto;"></img></center></a>
                          <center><div style="color:white; font-size:20px; font-style: italic; float:center;"><strong> </strong></div>
                         </center>
						...
						<div class="modal-dialog w-100 mx-auto">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="h5 modal-title text-center">
                                       <h4 class="mt-2">
                                           <span style="font-style: italic;" class="text-primary"><strong>Patient Login</strong></span>
                                        </h4>
                                    </div>
                                    ...
                                    <form class="" method="post" action="<?php echo base_url().'patient/patient/plogin' ?>" parsley-validate>
							...
							<div class="form-group row">
                               <div class="col-sm-12">
                                  ...
                                  <h6 class="mb-0">No account? <a href="<?php echo base_url().'registration' ?>" class="text-primary">Sign up now</a></h6>-->
                                </div>
                                <div class="modal-footer clearfix">
                                    <div class="float-left"><a href="<?php echo base_url().'patient/patient/forget_password' ?>" class="btn-lg btn btn-link">Forgot password</a></div>
