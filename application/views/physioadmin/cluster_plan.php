                ...
                <div class="content-wrapper">
                   <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Enterprise Plan Clients</h1>
                            <small>Enterprise Plan Clients</small>
...
$('#client_id').change(function(){
		 ...
		 window.location="<?php echo base_url() ?>physioadmin/client_det/enterprise_plan/search/"+value;
	});
	...
	$('#refresh').click(function(){
		  window.location="<?php echo base_url() ?>physioadmin/client_det/enterprise_plan/";
	});
...
$('#SearchMe').click(function(e){
	...
	$('#ExportMe').click(function(e){
		e.preventDefault();
			...
			window.location = '<?php echo base_url();?>physioadmin/client_det/export_enterprize/' ;
