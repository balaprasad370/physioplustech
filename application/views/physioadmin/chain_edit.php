                 ...
                 <div class="content-wrapper">
                    <section class="content-header">
                        ...
                        <div class="header-title">
                            <h1>Ultimate Prescriber Plan Edit</h1>
                                        ...
                                        <form action="<?php echo base_url().'physioadmin/client_det/edit_plan' ?>" method="post" class="form-horizontal" role="form"  parsley-validate id="basicvalidations">
										  ...
										  <div class="form-group">
											...
											<div class="col-sm-8" id="selectbox1">
												...
												<option value="368" >368 DAYS</option>
											   </select>
											</div>
										  </div>
										  <div class="form-group">
					...
					<div class="col-sm-6">
									<div class="panel panel-bd lobidrag">
									 <div class="panel-body">
									  <form action="<?php echo base_url().'physioadmin/client_det/edit_client_balance' ?>" method="post" class="form-horizontal" role="form"  parsley-validate id="wallet_balance_form">
										<h1><strong>Client wallet balance</strong> </h1></br>
										<div class="col-sm-12 form-group">	
											<div class="col-sm-6 form-group">
													<label>Current Balance</label>
													
													<input type="text" name="curr_wallet_balance" id="curr_wallet_balance" value="<?=$wallet_balance?>" class="form-control" readonly>
											 </div>
											 <div class="col-sm-6 form-group pull-right">
													<label>Add Balance</label>
													<input type="hidden" value="<?php echo $clint_id; ?>" name="client_id" id="client_id">
													<input type="text" name="wallet_balance_add" id="wallet_balance_add" value="" class="form-control">
											 </div>
											 <div class="col-sm-6 form-group pull-right">
													<label>Minus Balance</label>
													<input type="text" name="wallet_balance_minus" id="wallet_balance_minus" value="" class="form-control">
											 </div>										</div>
...
$("#wallet_balance_add").keyup(function() {
		var $this = $(this);
		$this.val($this.val().replace(/[^\d.]/g, ''));        
	});
	$("#wallet_balance_minus").keyup(function() {
		var $this = $(this);
		$this.val($this.val().replace(/[^\d.]/g, ''));        
	});});
