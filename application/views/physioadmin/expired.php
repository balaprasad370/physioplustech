                                    ...
                                    <div class="panel-body">
                                     <div class="table-responsive">
									  ...
									  ?>
										...
										<td><?php echo $renewal_lists['expire_date']; ?></td>
										<td><?php echo $renewal_lists['tot_pay_amount']; ?></td>
										<td><?php echo $renewal_lists['mobile'].'<br>'.$renewal_lists['phone']; ?></td>
										<td><a href="<?php echo base_url().'physioadmin/client_det/view_history/'.$renewal_lists['client_id']; ?>" ><button class="btn btn-dutch example-p-2">View History</button></a>&nbsp;&nbsp;<a target="_blank" class="btn btn-dutch" href="<?php echo 'https://web.whatsapp.com/send?phone=91'.$renewal_lists['mobile']; ?>"> <span class="badge" style="background-color:#15A8D7;">Whatsapp</span> </a></center></td>
										</tr>
									  <?php $i++; }}?>
									   </tbody>
								  </table>
