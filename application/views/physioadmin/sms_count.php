									...
									<div class="table-responsive" style="background-color:#f4f9f3;">
                                     ...
                                     <table class="table table-bordered table-hover">
										  ...
										  <th>Action</th>
											...
											<tbody>
											<?php if($sms_count != false){ 
												foreach($sms_count as $sms_det){
									  
									  ?>
											<tr>
												<td><?php echo $sms_det['client_id']; ?></td>
											<td><?php echo $sms_det['username'];  ?></td>
											<td><?php echo $sms_det['sms_count'];  ?></td>
											<td><?php echo $sms_det['total_sms_limit']; ?></td>				
											<td><a href="<?php echo base_url().'physioadmin/client_det/sms_edit/'.$sms_det['client_id']; ?>" class="btn btn-dutch"><span class="badge" style="background-color:#15A8D7;">Edit</span></a></td>
										</tr>
									  <?php }}?>
									   </tbody>
								  </table>
...
$('#client_id').change(function(){
		 ...
		 window.location="<?php echo base_url() ?>physioadmin/client_det/sms_count/search/"+value;
	});
	...
	$('#refresh').click(function(){
		  window.location="<?php echo base_url() ?>physioadmin/client_det/sms_count/";
	});
...
$('#ExportMe').click(function(e){
		e.preventDefault();
			...
			window.location = '<?php echo base_url();?>physioadmin/client_det/export_smscount/' ;
