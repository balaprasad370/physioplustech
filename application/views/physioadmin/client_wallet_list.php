                                    ...
                                    <div class="panel-body">
                                     ...
                                     <table class="table table-bordered table-hover" id="wallet_table">
										  ...
										  <th>Action</th>
											...
											<tbody>
											<?php if($wallet_balance != false){ 
												foreach($wallet_balance as $wallet_data){
									  
									  ?>
											<tr>
												<td><?php echo $wallet_data['client_id']; ?></td>
											<td><?php echo $wallet_data['name'];  ?></td>
											<td><?php echo $wallet_data['price'];  ?></td>
											<td><a href="<?php echo base_url().'physioadmin/client_det/ultimate_edit/'.$wallet_data['client_id']; ?>" class="btn btn-dutch"><span class="badge" style="background-color:#15A8D7;">Edit</span></a></td>
										</tr>
									  <?php }}?>
									   </tbody>
								  </table>
