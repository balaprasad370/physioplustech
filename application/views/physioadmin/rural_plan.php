                                       ...
                                       <div class="table-responsive" style="background-color:#f4f9f3;">
											<table class="table table table-hover"><tr>
												   ...
												   <select name="client_name" id="client_name"  placeholder="Please select client" class="chosen-select chosen-transparent form-control" style="width: 260px;" >
														...
														<td><select name="city" id="city" width="200%" placeholder="Please select city" class="chosen-select chosen-transparent form-control" style="width: 260px;">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
	...
	$('#client_id').change(function(){
		 ...
		 window.location="<?php echo base_url() ?>physioadmin/client_det/free_plan/search/"+value;
	});
	...
	$('#refresh').click(function(){
		  window.location="<?php echo base_url() ?>physioadmin/client_det/free_plan/";
	});
	...
	$('#city').change(function(){
		 var value=$('#city').val();
		 window.location="<?php echo base_url() ?>physioadmin/client_det/free_plan/city/"+value;
	});
...
$('#ExportMe').click(function(e){
		e.preventDefault();
			...
			window.location = '<?php echo base_url();?>physioadmin/client_det/export_free/' ;
