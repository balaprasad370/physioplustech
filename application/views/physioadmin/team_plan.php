...
$('#client_id').change(function(){
		 ...
		 window.location="<?php echo base_url() ?>physioadmin/client_det/monetary_plan/search/"+value;
	});
	...
	$('#refresh').click(function(){
		  window.location="<?php echo base_url() ?>physioadmin/client_det/monetary_plan/";
	});
...
$('#SearchMe').click(function(e){
	...
	$('#ExportMe').click(function(e){
		e.preventDefault();
			...
			window.location = '<?php echo base_url();?>physioadmin/client_det/export_monetary/' ;
