                ...
                <div class="content-wrapper">
                   <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Professional Plan Clients</h1>
                            <small>Professional Plan Clients</small>
                                ...
                                <div class="panel panel-bd ">
									...
									<div class="table-responsive" style="background-color:#f4f9f3;" >
														...
														<?php
															if ($client_name!=false) {
																foreach ($client_name as $patient_names) {
																	echo '<option value="'.$patient_names['client_id'].'">'.$patient_names['first_name'].' '.$patient_names['last_name'].'</option>';
																}
															}
														?>
													</select>
                                     ...
                                     <table class="table table-bordered table-hover">
											...
											<tbody>
											<?php if($solo_list != false){ 
												$c = $this->uri->segment(5)+1;
												foreach($solo_list as $solo_client){
											?>
										<tr>
											<td><?php echo $c; ?></td>
											<td><?php echo $solo_client['client_id']; ?></td>
											<td><?php echo $solo_client['username'];  ?></td>
											<td><?php echo $solo_client['expire_date']; ?></td>
											<?php if($solo_client['status'] != '0'){ ?>
											<td><?php echo 'Active' ?></td>
											<?php } else { ?>
											<td><?php echo 'Inactive' ?></td>
											<?php } ?>
											<td><a class="btn btn-dutch" href="<?php echo base_url().'physioadmin/client_det/usage_list/'.$solo_client['client_id'] ?>"><span class="badge" style="background-color:#15A8D7;">Usage View</span> </a>&nbsp;&nbsp;<a href="<?php echo base_url().'physioadmin/client_det/professional_edit/'.$solo_client['client_id']; ?>" class="btn btn-greensea"><span class="badge" style="background-color:#D72F15;">Edit</span></a>&nbsp;&nbsp;<a target="_blank" class="btn btn-dutch" href="<?php echo 'https://web.whatsapp.com/send?phone=91'.$solo_client['mobile']; ?>"> <span class="badge" style="background-color:#15A8D7;">Whatsapp</span> </a></center></td>
											</tr>
									  <?php $c++; } }?>
									   </tbody>
								  </table>
...
$('#client_id').change(function(){
		 ...
		 window.location="<?php echo base_url() ?>physioadmin/client_det/professional_plan/search/"+value;
	});
	...
	$('#refresh').click(function(){
		  window.location="<?php echo base_url() ?>physioadmin/client_det/professional_plan/";
	});
...
$('#ExportMe').click(function(e){
		e.preventDefault();
			...
			window.location = '<?php echo base_url();?>physioadmin/client_det/export_professional/' ;
