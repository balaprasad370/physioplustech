        ...
        <div class="wrapper">
                ...
                <div class="content-wrapper">
				  ...
				  ?>
						<tr>
							<td><?php echo $c ?></td>
					<td><?php echo $client_lists['name']; ?></td>
					<td><?php echo $client_lists['email'];  ?></td>
					<td><?php echo $client_lists['mobile'];  ?></td>
					<td><?php echo $client_lists['requirement'];  ?></td>
					<td><?php echo $client_lists['duration'];  ?></td>
					<td><?php echo $client_lists['login']. " & " .$client_lists['login'] ;  ?>  </td>
					<td>
					<a href="<?php echo base_url().'physioadmin/dashboard/quotation_print/'.$client_lists['id'];?>" class="btn btn-dutch" target="_blank"><span class="badge" style="background-color:#009688;">Print</span></a>
					&nbsp;&nbsp;<a target="_blank" class="btn btn-dutch" href="<?php echo 'https://web.whatsapp.com/send?phone=91'.$client_lists['mobile']; ?>"> <span class="badge" style="background-color:#15A8D7;">Whatsapp</span> </a>
