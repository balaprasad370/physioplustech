                ...
                <div class="content-wrapper">
                   <section class="content-header">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Ultimate Prescriber plan Clients</h1>
                            <small>Ultimate Prescriber plan Clients</small>
...
$('#client_id').change(function(){
		 ...
		 window.location="<?php echo base_url() ?>physioadmin/client_det/ultimate_plan/search/"+value;
	});
	...
	$('#refresh').click(function(){
		  window.location="<?php echo base_url() ?>physioadmin/client_det/ultimate_plan/";
	});
...
$('#ExportMe').click(function(e){
		e.preventDefault();
			...
			window.location = '<?php echo base_url();?>physioadmin/client_det/export_ultimate/' ;
