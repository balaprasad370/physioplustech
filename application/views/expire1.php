		...
		<div class="row-fluid">
			...
			<div class="span7 homeabout">
				...
				<h3>Scheduling: </h3>
					<div class="row">
							 <ul>
								<li>Book appointment for individual therapists </li><br>
								<li>Notify patient & therapist via e-mail & SMS instantly </li><br>
								<li>Appointment cancelation available  </li><br>
								<li>Canceled appointments  report  also available </li>
							 </ul>
					</div>			
