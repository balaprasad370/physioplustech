...
<head>
    ...
    <!-- alternative styles -->
    <link href="<?php echo base_url() ?>css/bigstars.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url() ?>css/antenna.css" rel="stylesheet" type="text/css">
  <link href="<?php echo base_url() ?>css/svg.css" rel="stylesheet" type="text/css">
    <!-- syntax highlighter -->
    <link href="<?php echo base_url() ?>css/shCore.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url() ?>css/shCoreDefault.css" rel="stylesheet" type="text/css">
</head>
<body>
...
%>
    ...
    <script src="<?php echo base_url() ?>js/shBrushXml.js" type="text/javascript"></script>

    <script src="<?php echo base_url() ?>js/shBrushCss.js" type="text/javascript"></script>

    <script src="<?php echo base_url() ?>js/shBrushCSharp.js" type="text/javascript"></script>
