							...
							.badge {
							 ...
							 <div class="col-md-2 app-inner-layout__sidebar card">
                                <ul class="nav" id="ullist">
                                    <li class="nav-item"><a href="#tab-faq-1" data-toggle="tab" class="nav-link active dropdown-item" style='display:none'>
									 <div class="badge ml-0 mr-2 badge-dot badge-dot-xl badge-success">Dark</div>
										Patient Profile
                                    </a></li>
									 <li class="nav-item"><a href="#tab-faq-2" data-toggle="tab" class="nav-link dropdown-item active show">
									...
									<div class="badge ml-0 mr-2 badge-dot badge-dot-xl badge-primary" >Dark</div>
                                            Ax Templates</a></li>  
                                    <li class="nav-item" style='text-align: left;width: 207px;'><a href="#tab-faq-5" data-toggle="tab" class="nav-link dropdown-item" >
