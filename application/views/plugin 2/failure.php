...
<div class="container"> 
  ...
  <h3><center> Your Details has not been Verified.  </center> </h3>
  </br></br><a href="<?php echo base_url().'plugin/dashboard/index/'.$this->session->userdata('client_id');  ?>"><font color="red"><center>Retry</center></font></a>
  </form>
</div>
