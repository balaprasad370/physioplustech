                        ...
                        <div class="row">
                          <div class="col-md-12">
								...
								<div class="page-title-subheading opacity-10">
                                    ...
                                    <div class="card-body"><h5 class="card-title">Education</h5>
  ...
  $(function(){
	$('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/private_exercise/private_education/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/private_exercise/private_education/search/'+searchType+'/'+position;
		 } else {
