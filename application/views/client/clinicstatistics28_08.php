																											...
																											<div class="br-1">
																												<div class="row">
																													...
																													<div class="col-6 p-1 arrow">
																														<a href="<?php echo base_url().'application/view/client/view_patient.php' ?>" class="fa fa-angle-left" aria-hidden="true"></a>
																													</div>
																												</div>
																												<div class="row">
																													<div class="col-5 p-1">
																														<small>Consultant Name</small>
																														<div><strong>Name Consultant</strong></div>
																													</div>
																													<div class="col-4 p-1">
																														<small>Time</small>
																														<div><?php echo $row['treatment_date']; ?></div>
																													</div>
