                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"> Progress Notes
								</h5>
                                    <form class="" action="<?php echo base_url().'client/patient/add_prog_notes' ?>" method="post"  role="form" parsley-validate id="signupForm">
                                         <input type="hidden" name="pn_id" value="<?php echo $pn_id ?>"  />
						                 <input type="hidden" name="patient_id" id="patient_id" value="<?php echo $patient_id ?>"  />
										<div class="form-row">
                                             <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="pn_date" class="">Date</label>
												 <input name="pn_date" value="<?php echo date('d-m-Y',strtotime($prognotes['pn_date'])); ?>" type="text" class="form-control datepicker" data-toggle="datepicker" parsley-trigger="change" parsley-required="true" autocomplete="off"></div>
												</div>
											 
                                             <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="prog_notes" class="">Progress notes</label>
												<textarea rows="3" class="form-control autosize-input form-rounded" id="prog_notes" name="prog_notes" parsley-trigger="change" parsley-required="true"><?php echo $prognotes['prog_notes'] ?></textarea>
												 </div>
												</div>
                                            </div>
