			...
			<div class="row">
							  <div class="col-md-12">
							   <?php if($this->uri->segment(4) == 'both')	{ ?>  
								   <h5 class="card-title" style="text-transform:capitalize;"><?php echo $name.' Revenue Chart ('.date('d-m-Y', strtotime($this->uri->segment(5))) .' and '.date('d-m-Y', strtotime($this->uri->segment(6))) .' )'; ?></h5>
                                 <?php } else { ?>
								   <h5 class="card-title" style="text-transform:capitalize;"><?php echo $name.' Revenue Chart ('.date('d-m-Y', strtotime('-30 days')) .' and '.date('d-m-Y').' )'; ?></h5>
              ...
              <div class="span12">
                <?php if($re_list != false){ ?>
						<?php if($this->uri->segment(4) == 'both')	{ ?>  
                                 ...
                                 <?php } ?><table  class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
                          <tr>
