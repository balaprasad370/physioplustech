...
$chartDet = $CI->exercise_model->getcharts($chart_no);
...
<p><h6><font color="#6699FF">Address : <?php echo $clientDetails['address']; ?></font></h6></p>
<p><h6><font color="#6699FF">Phone No : <?php echo $clientDetails['phone']; ?></font></h6></p>
</td>
<?php 
	$total = 0; 
    ...
    <div class="row-fluid" style="margin-bottom: 15px;">
		...
		<?php 	
				foreach($chartDet as $img){ 
						$str1 = explode("https://www.physioplustech.in/uploads/exercise/",$img['img_path']);
							$id1 = end($str1);
					if($str1[0] != ''){		
				?>
				<tr><td width="347">
				...
				<?php } else { ?>
				<tr><td width="347">
					<img src="<?php echo $img['img_path']; ?>" height="250px;" width="250px;" >					
					<input type="hidden" id="path" name="path[]" value="<?php echo $img['img_path']; ?>" >
					</td>
					<td width="400">
						<p align="center"><strong><?php echo $img['title'] ?></strong></p><br>
