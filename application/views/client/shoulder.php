...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Shoulder - Physio Plus Tech</title>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    </div><div class="card-body"><h5 class="card-title">Shoulder</h5>
					...
					<table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
				         ...
				         <option value="1">Aarom</option>
						 <option value="2">Ball</option>
						 <option value="3">Elastic Band</option>
						 <option value="4">Free Wight</option>
						 <option value="5">Machines and Cables</option>
						 <option value="6">Miscellaneous</option>
						 <option value="7">Neural Glides</option>
						 <option value="8">Pulley</option>
						 <option value="9">Stretches</option>
						 <option value="10">Arom</option>
						 <option value="11">Bosu</option>
						 <option value="12">Foam Roll</option>
						 <option value="13">Isometric</option>
						 <option value="14">Medicine Ball</option>
						 <option value="15">Mobilization</option>
						 <option value="16">Pendulum</option>
						 <option value="17">Stabilization</option>
						 <option value="18">Wand</option>
						 <option value="19">6 Way Shoulder</option>
														...
														<div class="no-gutters row">
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															...
															<div class="col-sm-3 container superbox-list img-view" >
																<a href="<?php echo base_url().'client/exercise/shoulder' ?>"> <div class="widget-chart widget-chart-hover">
  ...
  $(function(){
	 $('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/shoulder/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/shoulder/search/'+searchType+'/'+position;
		 } else {
