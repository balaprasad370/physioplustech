														  ...
														  <button type="submit" id="group_invoice1" class="btn btn-pill btn-danger">Generate Invoice</button>
															 ...
															 <table  class="table table-striped table-bordered" id="basicDataTable">
																...
																<tr id="<?php echo $infosess['patient_id'].'encounter'.$infosess['sn_id'] ?>">
																	...
																	<td class="text-center" ><?php if($infosess['sn_date']) echo date('d/m/Y', strtotime($infosess['sn_date'])); ?></td>
											  ...
											  <div class="tab-pane show" id="protocls" role="tabpanel">
													<div class="main-card mb-12">
														...
														<div class="row">
                                                            ...
                                                            <div class="input-group">
															 <div class="position-relative form-group"><label for="bill_no" class=""> ( OR ) No of Days</label>
															     <input type="text" style="width:250px;" class="form-control" placeholder="Enter No Of Days" parsley-trigger="change" parsley-required="true" id="no_of_days" name="no_of_days" rows="4"/>
															</div>
															</div> 	
															</div>	
															<div class="col-md-4">	
														...
														<?php } ?>
														  ...
														  <td data-field="treatDate_<?php echo $treatments['treatment_id']; ?>" style="vertical-align: middle"><?php if($treatments['treatment_date']=="0000-00-00") { echo "  -  "; } else { echo date('d/m/Y', strtotime($treatments['treatment_date'])); }  ?></td>
														  <td data-field="treatment_<?php echo $treatments['treatment_id']; ?>" style="vertical-align: middle"><?php echo $treatments['itemName']; ?> </td>
                                                           <td data-field="treatQty_<?php echo $treatments['treatment_id']; ?>" style="vertical-align: middle"><?php echo $treatments['noofdays']; ?></td>
							 ...
							 <div class="col-md-2 app-inner-layout__sidebar card">
                                <ul class="nav" id="ullist" >
                                    <li class="nav-item"><a href="#tab-faq-1" data-toggle="tab" class="nav-link  dropdown-item" style='display:none'>
									 ...
									 <li class="nav-item"><a href="#tab-faq-2" data-toggle="tab" class="nav-link dropdown-item active">
