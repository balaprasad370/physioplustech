                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"> Pediatric Examination Details
								</h5>
                                    <form class="" action="<?php echo base_url().'client/patient/add_paediatric' ?>" method="post"  role="form" parsley-validate id="signupForm">
                                         <input type="hidden" name="paediatric_id" value="<?php echo $paediatric_id ?>"  />
						                 <input type="hidden" name="patient_id" id="patient_id" value="<?php echo $patient_id ?>"  />
											 ...
											 <div class="row">
													     <div class="col-md-4">
														  <div class="input-group">
															<div class="position-relative form-group"><label for="bill_no" class="">Date</label>
																<input type="text" class="form-control datepicker" Placeholder="Date" name="paediatric_date" id="paediatric_date" value="<?php echo date('d-m-Y',strtotime($paediatric['paediatric_date'])); ?>" data-toggle="datepicker">
															</div>
															</div>
															</div>
															<div class="col-md-4">
															<div class="input-group">
																...
																<input placeholder="Language" type="text" name="language" id="language"  class="form-control" value="<?php echo $paediatric['language'] ?>">
															</div>															
															</div>															
															</div>
														<div class="col-md-4">
														<div class="input-group">
																...
																<textarea class="form-control"  id="milestone" name="milestone" rows="2"><?php echo $paediatric['milestone'] ?></textarea>
														</div> 
														</div> 
													   </div>															
													  </div>	
													<div class="row">
													  <div class="col-md-4">	
														<div class="input-group">
																...
																<input placeholder="Social" type="text" name="social" id="social" class="form-control" value="<?php echo $paediatric['social'] ?>">
														</div>											
														</div>											
													  </div>
													  <div class="col-md-4">	
														<div class="input-group">
																...
																<input placeholder="Fine Motor" type="text" name="finemotor" id="finemotor" class="form-control" value="<?php echo $paediatric['finemotor'] ?>">
														</div>											
														</div>											
													  </div>
													  <div class="col-md-4">	
														<div class="input-group">
																...
																<input placeholder="Gross Motor" type="text" name="grossmotor" id="grossmotor" class="form-control" value="<?php echo $paediatric['grossmotor'] ?>">
														</div>											
														</div>											
													  </div>													  
													</div></br>
													<div class="row">
													 <div class="col-md-4">	
														<div class="input-group">
																...
																<input placeholder="Reflexes" type="text" name="reflexes" id="reflexes" class="form-control" value="<?php echo $paediatric['reflexes'] ?>">
														</div>											
														</div>											
													  </div>
													  </div>
