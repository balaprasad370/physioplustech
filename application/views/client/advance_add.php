...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"> New Advance
								</h5>
										...
										?> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="bill_no" class="">Date *</label>
												 <input name="advance_date" placeholder="" type="text" class="form-control datepicker" data-toggle="datepicker"></div>
												</div>
                                            </div>
								...
								<option value="Phonepe" >Phonepe</option>
											...
											<div class="col-md-6">
												...
												<input name="advance_amount" id="advance_amount" type="text" class="form-control" parsley-type="number" parsley-required="true">
												</div>
                                            </div>
                                        </div>
										...
										<div class="form-row">
                                             <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="notes" class="">Notes</label>
												 <textarea rows="3" class="form-control autosize-input form-rounded" id="notes" name="notes"></textarea>
												</div>
                                            </div>
										...
										<div class="form-row">
											...
											<div class="col-md-6">
												...
												<input name="cheque_no" id="cheque_no" type="text" class="form-control subheading">
												</div>
                                            </div>
    ...
    <div id="toast-container"  style="display:none;" class="toast-top-right"><div class="toast toast-success" aria-live="polite" style=""><div class="toast-message">Success!</br>Advance Has Been Added Successfully</div></div></div>
    <div id="toast-container1" style="display:none;" class="toast-top-right"><div class="toast toast-error" aria-live="polite" style=""><div class="toast-error">error!</br>Advance Has not Been Added Successfully</div></div></div>
