											  ...
											  <div class="tab-pane show" id="protocls" role="tabpanel">
													<div class="main-card mb-12">
														...
														<?php } ?>
														  ...
														  <td data-field="treatDate_<?php echo $treatments['treatment_id']; ?>" style="vertical-align: middle"><?php if($treatments['treatment_date']=="") { echo "-"; } else { echo date('d/m/Y', strtotime($treatments['treatment_date'])); }  ?></td>
