      ...
      <div class="app-main__outer">
                        ...
                        <div class="tab-content">
                           ...
                           <div class="tab-pane tabs-animation fade" id="tab-content-0" role="tabpanel">
                              <div class="row mob" ng-controller="customersCrtl1">
                                 <div class="col-md-12">
                                    <div class="main-card mb-3" ng-controller="customersCrtl1">
                                       <div class="col-md-12" >
                                          <div class="" style="font-size: 13px;">
                                             <table class="table table-striped table-bordered">
                                                <thead>
		...
		$this->db->where('home_visit',2);
                                                      ...
                                                      <?Php $edit = explode(",",$this->session->userdata('edit'));
                                                         ...
                                                         <?php } ?>
                                                         <br>
                                                         <div class="badge badge-pill badge-info">{{data.patient_code}}</div></td>
                                                      ...
                                                      <?Php $edit = explode(",",$this->session->userdata('edit'));
                                                         ...
                                                         <br>
                                                         <div class="badge badge-pill badge-info">{{data.patient_code}}</div></td>
                                                      <td class="text-center">{{data.appoint_date}}<br>
													  
                                                       <a href="https://api.whatsapp.com/send?l=en&phone=91{{data.mobile_no}}" target="_blank"><img src="<?php echo base_url().'img/whatsapp Logo.png' ?>" style="width:18px; height:18px;" ></img> {{data.mobile_no}}</a> <br>
                                                     {{data.email}}</td>
                                                      <td class="text-center">
