...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Ankle - Physio Plus Tech</title>
								...
								<div class="page-title-subheading opacity-10">
                                        <nav class="" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item">
                                                    <a href="<?php echo base_url().'client/exercise/public_exercise' ?>" >EXERCISE VIEW</a>
                                                </li>
                                                <li class="active breadcrumb-item" aria-current="page">
												  ...
												  $whatIWant = substr($data, strpos($data, "/s") + 1);
 //echo strlen($whatIWant);
													   $position=substr($_SERVER['REQUEST_URI'], 33,1);
													   $searctype=substr($_SERVER['REQUEST_URI'], 30,2);
                                    ...
                                    <div class="card-body"><h5 class="card-title">Ankle and Foot</h5>
					 ...
					 <table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
				         ...
				         <option value="01" <?php if($searctype=="01"){?>selected="selected"<?php } ?> >Arom</option>
						 <option value="02" <?php if($searctype=="02"){?>selected="selected"<?php } ?>>Ball</option>
						 <option value="03" <?php if($searctype=="03"){?>selected="selected"<?php } ?>>Bosu</option>
						 <option value="04" <?php if($searctype=="04"){?>selected="selected"<?php } ?>>Elastic Band</option>
						 <option value="05" <?php if($searctype=="05"){?>selected="selected"<?php } ?>>Isometric</option>
						 <option value="06" <?php if($searctype=="06"){?>selected="selected"<?php } ?>>Miscellaneous</option>
						 <option value="07" <?php if($searctype=="07"){?>selected="selected"<?php } ?>>Mobilization</option>
						 <option value="08" <?php if($searctype=="08"){?>selected="selected"<?php } ?>>Prom</option>
						 <option value="09" <?php if($searctype=="09"){?>selected="selected"<?php } ?>>Stabilization</option>
						 <option value="10" <?php if($searctype=="10"){?>selected="selected"<?php } ?>>Stretches</option>
						</select> </td>
					  <td> Position
					    <select class="chosen-select chosen-transparent form-control" name="position" id="position" placeholder="Select Position">
						<option value="0" <?php if($position=="0") { ?> selected="selected"<?php }?>>All</option>
						<option value="1" <?php if($position=="1") { ?> selected="selected"<?php }?>>Kneeling</option>
						<option value="2" <?php if($position=="2") { ?> selected="selected"<?php }?>>Prone</option>
						<option value="3" <?php if($position=="3") { ?> selected="selected"<?php }?>>Quadruped</option>
						<option value="4" <?php if($position=="4") { ?> selected="selected"<?php }?>>Side Lying</option>
						<option value="5" <?php if($position=="5") { ?> selected="selected"<?php }?>>Sitting</option>
						<option value="6" <?php if($position=="6") { ?> selected="selected"<?php }?>>Standing</option>
						<option value="7" <?php if($position=="7") { ?> selected="selected"<?php }?>>Supine</option>
					    </select> </td>
				       <td></br><input type="text" name="keyword"  Placeholder="Please Enter Value"  class="form-control" id="keyword">  </td>
					   <td></br><button class="btn btn-shadow btn-danger" id="SearchMe" > Go</button> </td><td></br><a class="btn btn-shadow btn-warning" href="<?php echo base_url().'client/exercise/ankle/search/0/0' ?>" ><strong>Reset</strong></a></td>
					   </tr>
						</table>
						</div>
									 <div class="card-body">
											<div class="main-card mb-3">
													<div class="grid-menu grid-menu-4col">
														<div class="no-gutters row">
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															if ($images != false) { foreach($images as $img){ ?>
															<div class="col-sm-3 container superbox-list img-view" >
															<?php if(strlen($whatIWant)>20) { ?>	<a href="<?php echo base_url().'client/exercise/ankle/' ?>"><?php } ?><?php if(strlen($whatIWant)<=20) { ?>	<a href="<?php echo base_url().'client/exercise/ankle/'.$whatIWant?>"><?php } ?> <div class="widget-chart widget-chart-hover">
																		<img src="<?php echo $site.$img['path'] ?>" style="width: 150px; height: 150px" id="<?php echo 'imgid'.$img['id']; ?>" data-img="<?php echo $site.$img['path'] ?>" class="superbox-img" alt>
                          ...
                          <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Selected Images</h5>
                                      <div class="card-body"> 
										<a href="<?php echo base_url().'client/exercise/editorchart' ?>"><button class="mb-2 mr-2 btn btn-pill btn-primary" style="float:right;">Editor
												</button></a>
  ...
  $(function(){
	$('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/ankle/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/ankle/search/'+searchType+'/'+position;
		 } else {
