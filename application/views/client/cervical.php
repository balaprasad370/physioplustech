...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Cervical - Physio Plus Tech</title>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
 ...
 //echo strlen($whatIWant);
													   $position=substr($_SERVER['REQUEST_URI'], 36,1);
													   $searctype=substr($_SERVER['REQUEST_URI'], 33,1);
                                    ...
                                    </div><div class="card-body"><h5 class="card-title">Cervical</h5>
					...
					<table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
				         ...
				         <option value="1" <?php if($searctype=="1"){?>selected="selected"<?php } ?>>AAROM</option>
						 <option value="2" <?php if($searctype=="2"){?>selected="selected"<?php } ?>>Arom</option>
						 <option value="3" <?php if($searctype=="3"){?>selected="selected"<?php } ?>>Elastic Band</option>
						 <option value="4" <?php if($searctype=="4"){?>selected="selected"<?php } ?>>Isometric</option>
						 <option value="5" <?php if($searctype=="5"){?>selected="selected"<?php } ?>>Miscellaneous</option>
						 <option value="6" <?php if($searctype=="6"){?>selected="selected"<?php } ?>>Mobilization</option>
						 <option value="7" <?php if($searctype=="7"){?>selected="selected"<?php } ?>>Prom</option>
						 <option value="8" <?php if($searctype=="8"){?>selected="selected"<?php } ?>>Stabilization</option>
						 <option value="9" <?php if($searctype=="9"){?>selected="selected"<?php } ?>>Stretches</option>
														...
														<div class="no-gutters row">
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															...
															<div class="col-sm-3 container superbox-list img-view" >
																<a href="<?php echo base_url().'client/exercise/cervical' ?>"> <div class="widget-chart widget-chart-hover">
  ...
  $(function(){
	  $('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/cervical/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/cervical/search/'+searchType+'/'+position;
		 } else {
