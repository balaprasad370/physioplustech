								...
								?>
										...
										<div class="form-row">
										    ...
										    <div class="col-md-6">
												...
												<select  name="perc"  style="width:96%;" class="chosen-select chosen-transparent form-control" placeholder="please Select Item " id="perc">
														<option value ="1" <?php if($invoice_hdr['perc'] == 1){ echo 'selected'; } else { }  ?> >%</option>
														<option value ="2" <?php if($invoice_hdr['perc'] == 2){ echo 'selected'; } else { }  ?>>INR</option>
												</select></div>
                                            </div>
											<div class="col-md-6">
                                                <div class="position-relative form-group"><label for="vendor" class="">Invoice generated by</label>
                                        ...
                                        <table class="mb-0 table" id="InvoiceTable">
											...
											?>
											  ...
											  <td><input type="text"  class="form-control tax" name="tax[]"  value="<?php echo $invoice_dtls['tax']? $invoice_dtls['tax'] : '0'?>"></td>
											  <td><input type="text"  class="form-control discount" name="discount[]"  value="<?php echo $invoice_dtls['discount']? $invoice_dtls['discount'] : '0'?>"></td>
