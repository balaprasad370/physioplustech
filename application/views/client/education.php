...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Education - Physio Plus Tech</title>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    </div><div class="card-body"><h5 class="card-title">Education</h5>
					...
					<table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
				         ...
				         <option value="1">Body Mechanics</option>
						 <option value="2">Gait Training</option>
						 <option value="3">Miscellaneous</option>
						 <option value="4">Positioning</option>
						 <option value="5">Stair Training</option>
						 <option value="6">Transfers</option>
														...
														<div class="no-gutters row">  
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															...
															<div class="col-sm-3 container superbox-list img-view" >
																<a href="<?php echo base_url().'client/exercise/education' ?>"> <div class="widget-chart widget-chart-hover">
  ...
  $(function(){
	$('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/education/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/education/search/'+searchType+'/'+position;
		 } else {
