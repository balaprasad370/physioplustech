...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Referral Website - Physio Plus Tech</title>
                                        ...
                                        <nav class="" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="active breadcrumb-item" aria-current="page">
                                                    WEBSITE REFERRALS VIEW
                                                </li>
                                            </ol>
                                        </nav>
                                    </div><div class="card-header">Website Referrals view
                                        ...
                                        <table class="table table-striped table-bordered">
						                   ...
						                   ?>
                                            <tr id="<?php echo $referal['referal_id']; ?>">
                                                 ...
                                                 <td class="text-center"><?php echo $referal['website_name']; ?></td>
