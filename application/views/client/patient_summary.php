                              ...
                              <div class="table-responsive">
                                 <table class="table table-striped" style="">
                                    <tr>
                                       ...
                                       <td>
                                          <div class="patient_idss">
                                             <select style="width: 200px !important; min-width: 200px; max-width: 200px;" class="patient_id" name="patient_id" id="patient_id">
                                                <option selected="true" disabled="disabled">Please Select</option>
                                                <?php
                                       ...
                                       <td>
                                          <div class="provDiag">
                                             <select style="width: 200px !important; min-width: 200px; max-width: 200px;" class="prov_diagnosis" name="prov_diagnosis" id="prov_diagnosis">
                                                <option selected="true" disabled="disabled">Please Select</option>
                                                <?php
                                       ...
                                       <td>
                                          <div class="category">
                                             <select style="width: 200px !important; min-width: 200px; max-width: 200px;" class="mobileno" name="mobileno" id="mobileno">
                                                <option selected="true" disabled="disabled">Please Select</option>
                                                <?php
                                                   if ($mobile != false) {
                                       ...
                                       <td>
                                          <div class="category2">
                                             <select style="width: 200px !important; min-width: 200px; max-width: 200px;" class="p_code" name="p_code" id="p_code">
                                                <option selected="true" disabled="disabled">Please Select</option>
                                                <?php
                                       ...
                                       <td>
                                          <div class="category1">
                                             <select style="width: 200px !important; min-width: 200px; max-width: 200px;" class="referrer" name="referrer" id="referrer">
                                                <option selected="true" disabled="disabled">Please Select</option>
                                                <?php
                                                   if ($name != false) {  
                           ...
                           <div class="card-body mob_none">
                              ...
                              <div class="table-responsive">
                                 <table class="table table-striped" style="">
                                    <tr>
                                       <td>   
														<input type="text" style="width: " autocomplete="off;" data-date-format='D-M-YYYY' class="form-control datepicker" placeholder="From" id="from" data-toggle="datepicker"/>
                                       </td>

                                       <td>   
														<input type="text" style="width: " autocomplete="off;" data-date-format='D-M-YYYY' class="form-control datepicker" placeholder="To" id="to" data-toggle="datepicker"/>
                                       </td>
												</tr>

												<tr>
                                       <td><button class="btn btn-success btn-pill" id="dateFilter" > Go</button></td>
                                       <td><button class="btn btn-info btn-pill" id="ExportMe"><i class="fa fa-download"></i></button></td>
												</tr>
                           ...
                           <div class="card-body mob">
                              <div class="table-responsive">
                                 ...
                                 <table class="table table-striped table-bordered">
                                    <thead>
                                       <tr>
                                          <th class="text-center">Name<br>Date<br>Mobile no.</th>
                                          <th class="text-center">Email<br>Address</th>
                                          <th class="text-center">Action</th>
                                       </tr>
                                    </thead>
                                    <tbody>
                                       ...
                                       <tr>
                                          <td class="text-center">
															<a href="<?php echo base_url().'client/patient/view/'.$row['patient_id'] ?>" ><?php echo $row['first_name'].'  '.$row['last_name']; ?></a>
															<br>
                                          ...
                                          <td class="text-center">
															<span style="white-space: normal; max-width: 150px; overflow: hidden; text-overflow: ellipsis; display: inline-block;"><?php echo $row['email']; ?></span>
															<br>
															<span style="white-space: normal; max-width: 150px; overflow: hidden; text-overflow: ellipsis; display: inline-block;"><?php echo $row['address_line1']; ?></span>
														</td>
