...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Special - Physio Plus Tech</title>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    </div><div class="card-body"><h5 class="card-title">Special</h5>
					...
					<table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
						 ...
						 <option value="4">Modalities</option>
						 <option value="5">Neuro</option>
						 <option value="6">Oral and Facial</option>
						 <option value="7">Vestibular</option>
														...
														<div class="no-gutters row">
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															...
															<div class="col-sm-3 container superbox-list img-view" >
																<a href="<?php echo base_url().'client/exercise/special' ?>"> <div class="widget-chart widget-chart-hover">
  ...
  $(function(){
	$('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/special/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/special/search/'+searchType+'/'+position;
		 } else {
