...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Lumbar - Physio Plus Tech</title>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    </div><div class="card-body"><h5 class="card-title">Lumber & Thoracic</h5>
					...
					<table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
						 ...
						 <option value="2">Elastic Band</option>
						 <option value="3">Medicine Ball</option>
						 <option value="4">Mobilization</option>
						 <option value="5">Stretches</option>
						 <option value="6">AROM</option>
						 <option value="7">Bosu</option>
						 <option value="8">Foam Roll</option>
						 <option value="9">Miscellaneous</option>
						 <option value="10">Stabilization</option>
						 <option value="11">Traction</option>
						</select> </td>
					  <td> Position
														...
														<div class="no-gutters row">
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															...
															<div class="col-sm-3 container superbox-list img-view" >
																<a href="<?php echo base_url().'client/exercise/lumbarthoracic' ?>"> <div class="widget-chart widget-chart-hover">
  ...
  $(function(){
	 $('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/lumbarthoracic/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/lumbarthoracic/search/'+searchType+'/'+position;
		 } else {
