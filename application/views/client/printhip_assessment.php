	...
	<table style="width:95%;"><tr><td>&nbsp;&nbsp;&nbsp;	Occupation :</td>
		...
		<table style="width:95%;">
           ...
           <?php if($details['Skin'] != false){?> <tr><td>&nbsp;&nbsp;&nbsp;	Skin changes :	</td><td colspan="3"><?php echo $details['Skin']; ?></td></tr>	<?php } ?>	
			...
			<?php if($details['pain_scale'] != false || $details['duration'] != false || $details['category'] != false || $details['worse'] != false || $details['Aggravating'] != false || $details['Relieving'] != false){?>
			<h4>Pain Description </h4>
			<?php } ?>
			<table style="width:95%;">
			<?php if($details['pain_scale'] != false){?><tr><td>&nbsp;&nbsp;&nbsp;  Pain scale (0-10): :</td><td colspan="3"><?php echo $details['pain_scale']; ?></td></tr><?php } ?>
