					     ...
					     <?php
						        ...
						        <div class="btn-group">  
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-shadow btn-wide float-right btn-hover-shine btn" style="background-color: Transparent; border: 1px solid gray; color:white;">
                                       <span class="badge badge-pill badge-danger ml-0 mr-1"><?php echo 365- $this->session->userdata('duration'); ?></span><font color="white"> Days Remaining</font>
										</span>
                                    </a>
								</div>&nbsp;&nbsp;  
								<?php } 
										...
										<div class="grid-menu grid-menu-2col">
                                            <div class="no-gutters row">
                                                ...
                                                <div class="col-sm-6">
													...
													</br><b>Settings <?php echo $this->session->userdata("whatsapp"); ?></b>
                                                    </button>
                                                </div>
                                            </div>
