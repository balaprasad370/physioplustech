             ...
             <div class="app-main__outer">
                <div class="app-main__inner">
													...
													<div class="">
														...
														<tr><td colspan="9"> <input style="width:100%;" type="text" ng-model="search" ng-change="filter()" placeholder="Search All Fields" class="form-control" /> </td>
															...
															<tr ng-if="data != 0" ng-show="filteredItems > 0" ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="data.bill_id">
																<td style="width:120px;" class="text-center"><a href="<?php echo base_url().'client/patient/view/' ?>{{data.patient_id}}">{{data.first_name}} {{data.last_name}}</a>
                                                                <br>{{data.treatment_date}}
                                                                <br class="text-center text-muted"> 
																<div class="badge badge-pill badge-info">{{data.bill_no}}</div>
																</td>

																<td class="text-center">{{data.paid_amt}}
																<br>{{data.net_amt}}
																<br>{{data.payment_mode}}
																</td>
																
														
																<td class="text-center">{{data.net_amt - data.paid_amt}}.00</br>
																<a ng-if="data.bill_status == 0" class="badge badge-pill badge-secondary" href="<?php echo base_url().'client/invoice/invoice_status_update/'; ?>{{data.bill_id}}/{{data.patient_id}}"><i class="fa fa-plus"></i> Add payment</a>
																<br><div ng-if="data.bill_status == 1" class="badge badge-pill badge-alternate" style="padding:.5em;">Paid </div>
													...
													<div class="main-card mb-3">
														...
														<div class="e">
															...
															<tr><td colspan="9"> <input style="width:100%;" type="text" ng-model="search" ng-change="filter1()" placeholder="Search All Fields" class="form-control" /> </td>
																...
																<tr ng-if="data != 0" ng-show="filteredItems > 0" ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="data.bill_id">
																	<td class="text-center">{{data.bill_date}}
																		<br class="text-center text-muted"> 
																	<div class="badge badge-pill badge-info">EXP-{{data.bill_no}}</div>
																	<br>{{data.ventor}}
																	</td>
																	<td class="text-center">{{data.amount}}.00
																		<br>{{data.tax_perc}}
																		<br>{{data.total_amt}}.00
																	</td>
					...
					<!-- Desktop view -->		
                     ...
                     <!-- Mobileview -->
										<div class="row mob" ng-controller="customersCrtl2">
											<div class="col-md-12">
												<div class="main-card mb-3">
													<div class="col-md-12" >
													<div class="">
														...
														<tr><td colspan="9"> <input style="width:100%;" type="text" ng-model="search" ng-change="filter2()" placeholder="Search All Fields" class="form-control" /> </td>
															...
															<tr ng-if="data != 0" ng-show="filteredItems > 0" ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="data.bill_id">
																<td class="text-center">{{data.advance_date}}
																	<br class="text-center text-muted"> 
																<div class="badge badge-pill badge-info">{{data.bill_no}}</div>
																</td>
																
																<td class="text-center">{{data.first_name}} {{data.last_name}}
																<br>{{data.advance_amount}}</td>
																 <td class="text-center">
                          ...
                          <!-- Desktop view -->
										<div class="row mob_none" ng-controller="customersCrtl2">
											<div class="col-md-12">
												<div class="main-card mb-3">
													<div class="col-md-12" >
													<div class="table-responsive">
                                      ...
                                      <div class="row mob" ng-controller="customersCrtl1">
										...
										<table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="text-center"> <div class="badge badge-pill badge-info"><a href="<?php echo base_url().'client/inventory/inventory_edit/'.$row['inventory_id']?>"><?php echo $info['code']; ?></a></div> 
                                                 	<br><?php if($info['pro_img'] != false){ ?>
											   ...
											   <?php } ?>
												...
												<td class="text-center"><?php echo $info['pro_name'] ?>
													<br> <?php echo $info['pro_category']?>
													<br> <?php echo ($row['stock'] - $quantity); ?>
												</td>
