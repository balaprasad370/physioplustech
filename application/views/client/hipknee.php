...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Hip & Knee - Physio Plus Tech</title>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body"><h5 class="card-title">Hip & Knee</h5>
					...
					<table  class="table table-datatable table-custom" id="basicDataTable">
					  <tr> <td> Search Type
					   <select class="sample chosen-select chosen-transparent form-control" name="searchType" id="searchType" placeholder="Position" >
						 ...
						 <option value="3">Cones</option>
						 <option value="4">Isometric</option>
						 <option value="5">Miscellaneous</option>
						 <option value="6">Open Chain</option>
						 <option value="7">Stretches</option>
						 <option value="8">4 Way Hip</option>
						 <option value="9">Balance</option>
						 <option value="10">Boxes & Steps</option>
						 <option value="11">Elastic Band</option>
						 <option value="12">Machines & Cables</option>
						 <option value="13">Mobilization</option>
						 <option value="14">Plyometrics</option>
						 <option value="15">AAROM</option>
						 <option value="16">Ball</option>
						 <option value="17">Closed Chain</option>
						 <option value="18">Foam Roll</option>
						 <option value="19">Medicine Ball</option>
						 <option value="20">Neural Glides</option>
						 <option value="21">Prom</option>
														...
														<div class="no-gutters row">
														   ...
														   <?php $site="https://exerciseprescriptions20.s3.ap-south-1.amazonaws.com/";
															...
															<div class="col-sm-3 container superbox-list img-view" >
																<a href="<?php echo base_url().'client/exercise/hipknee' ?>"> <div class="widget-chart widget-chart-hover">
  ...
  $(function(){
	$('#SearchMe').click(function () {
		 ...
		 if(searchType != '' && position != '' && key != '' ){
			window.location = '<?php echo base_url(); ?>client/exercise/hipknee/search/'+searchType+'/'+position+'/'+key;
		 } else if(searchType != '' && position != '' && key == '' ){
			 window.location = '<?php echo base_url(); ?>client/exercise/hipknee/search/'+searchType+'/'+position;
		 } else {
