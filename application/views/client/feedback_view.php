                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
									...
									<table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
											<?php  if($fb_record != false){ ?>
                                        
											<?php foreach ($fb_record as $fbrecord) { ?>
                                            <tr id="">
                                                <td class="text-center"><?php echo $fbrecord['visit_date']; ?></td>
												<td class="text-center"><?php echo $fbrecord['pfirst'].' '.$fbrecord['plast']; ?></td>
												<td class="text-center"><div class="rateit" data-rateit-value="<?php echo $fbrecord['total_rate'] ?>" data-rateit-ispreset="true" data-rateit-readonly="true"></div>
												<?php 
													switch($fbrecord['total_rate']){
														case 0:
															echo 'Bad';
															break;
														case 1:
												...
												<a class="edit" href="<?php echo base_url().'client/feedback/feedback_pr/'.$fbrecord['feedback_id'] ?>" target="_blank"><button class="mb-2 mr-2 btn-icon btn-icon-only btn-shadow btn-dashed btn btn-outline-success"><i class="fa fa-print"></i></button></a>
												<a href="<?php echo '#'.$fbrecord['feedback_id']; ?>" class="delete"><button class="mb-2 mr-2 btn-icon btn-icon-only btn-shadow btn-dashed btn btn-outline-danger delete"><i class="fa fa-trash-alt"> </i></button></a>
...
  $(document).ready(function() {
		$('.delete').on('click', function () {
			 ...
			 url ='<?php echo base_url().'client/feedback/delete/' ?>'+ patient_id; 
			 swal({
			  title: "Confirmation",
