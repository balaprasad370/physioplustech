...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Report - Physio Plus Tech</title>
                      ...
                      <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"> Send Reports To Patient
								</h5>
                                    <form class="" action="<?php echo base_url().'client/reports/send_mail' ?>" method="post"  role="form" parsley-validate id="signupForm">
										  ...
										  <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="vendor" class="">Patient Name</label>
												 <input name="Patient" id="Patient" type="text" class="form-control" value="<?php echo $detail['first_name'].' '.$detail['last_name']; ?>" readonly >
                                            </div>
											 </div>
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="patientEmail" class="">Patient Name *</label>
												 <?php if($detail['email']!=''){ ?>
												 <input name="patientEmail" id="patientEmail" type="text" class="form-control" value="<?php echo $detail['email']; ?>" readonly >
												<?php }else{ ?>
