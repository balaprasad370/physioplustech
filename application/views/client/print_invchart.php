              ...
              <div class="span12">
                <?php if($tr_list != false){ ?>
						<?php if($this->uri->segment(4) == 'both')	{ ?>  
								   <h5 class="card-title" style="text-transform:capitalize;"><?php echo $name.' Performance Report ('.date('d-m-Y', strtotime($this->uri->segment(5))) .' and '.date('d-m-Y', strtotime($this->uri->segment(6))) .' )'; ?></h5>
                                 <?php } else { ?>
								   <h5 class="card-title" style="text-transform:capitalize;"><?php echo $name.' Performance Report ('.date('d-m-Y', strtotime('-30 days')) .' and '.date('d-m-Y').' )'; ?></h5>
                                 <?php } ?>
