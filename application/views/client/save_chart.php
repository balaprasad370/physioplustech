                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"> Send Exercise Chart
                                    ...
                                    <form class="" action="<?php echo base_url().'client/exercise/add_chart' ?>" method="post" >
                                        <div class="form-row">
											<div class="col-md-6">
										...
										<div class="form-row">
                                           <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="mobile" class="">Mobile No  </label>
										...
										<div class="form-row day_view">
 
											
											<div class="col-md-12">
                                                <div class="position-relative form-group"><label for="bill_no" class="">Day Views</label>
												<div class="table-responsive">
												<table class="align-middle mb-0 table table-border table-striped table-hover"><tr>
							<td>
							<div class="custom-checkbox custom-control"><input type="checkbox" id="sun" name="sunday" value="Sunday" class="custom-control-input" >
							<label class="custom-control-label" for="sun">
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sunday&nbsp;&nbsp;</div>
							</td>
							<td><div class="custom-checkbox custom-control"><input type="checkbox" id="mon" name="monday" value="Monday" class="custom-control-input" >
							<label class="custom-control-label" for="mon">
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Monday&nbsp;&nbsp;</div>
							</td>
							<td><div class="custom-checkbox custom-control"><input type="checkbox" id="tue" name="tuesday" value="Tuesday" class="custom-control-input" >
							<label class="custom-control-label" for="tue">
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tuesday&nbsp;&nbsp;</div>
							</td>
							<td><div class="custom-checkbox custom-control"><input type="checkbox" id="Wed" name="wednesday" value="Wednesday" class="custom-control-input" >
							<label class="custom-control-label" for="Wed">
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wednesday&nbsp;&nbsp;</div>
							</td>
							<td><div class="custom-checkbox custom-control"><input type="checkbox" id="thu" name="thursday" value="Thursday" class="custom-control-input" >
							<label class="custom-control-label" for="thu">
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thursday&nbsp;&nbsp;</div>
							</td>
							<td><div class="custom-checkbox custom-control"><input type="checkbox" id="fri" name="friday" value="Friday" class="custom-control-input" >
							<label class="custom-control-label" for="fri">
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Friday&nbsp;&nbsp;</div>
							</td>
							<td><div class="custom-checkbox custom-control"><input type="checkbox" id="sat" name="saturday" value="Saturday" class="custom-control-input" >
...
$(document).ready(function() {
  ...
  $('form').on('submit', function (event) {
		 ...
		 if($("input[name=category]:checked").val() == "1"){
		  ...
		  var val=$('#name').val();
		  var spl= val.split('/');
		  var url = 'https://physioplustech.in/pages/pdf_verification/'+val1+'/'+spl[1]+'/public-'+val3;  
