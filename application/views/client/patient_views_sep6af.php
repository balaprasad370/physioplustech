                     ...
                     <div class="main-card mb-3 card">
                        ...
                        <div class="tab-content">
                              ...
                              <div class="row mob" >
                                 <div class="col-md-12">
                                    <div class="main-card mb-3" ng-controller="customersCrtl2">
                                             ...
                                             <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr ng-show="filteredItems > 0" ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="data.patient_id">
                                                      ...
                                                      <td class="text-center text-muted"> Test
                                                         {{data.appoint_date}}
                                                         <br>
                                       ...
                                       <div class="table-responsive">
                                          <div class="col-md-12" ng-show="filteredItems > 0">
                                             <div pagination="" max-size="maxMobSize" page="currentPage" on-select-page="setPage(page)" boundary-links="true" total-items="filteredItems" items-per-page="entryLimit" class="pagination-small" previous-text="&laquo;" next-text="&raquo;"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <div class="tab-pane tabs-animation fade" id="tab-content-0" role="tabpanel">
                              <div class="row mob" ng-controller="customersCrtl1">
                                 <div class="col-md-12">
                                    <div class="main-card mb-3" ng-controller="customersCrtl2">
                                       <div class="col-md-12" >
                                          <div class="" style="font-size: 13px;">
                                             <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                   <tr>
                                                      <td colspan="3"> <input style="width:100%;" type="text" ng-model="search" ng-change="filter1()" placeholder="Search All Fields" class="form-control" /> </td>
                                                   </tr>
                                                   <?php 										 $this->db->select('*')->from('tbl_patient_info')->where('client_id', $this->session->userdata('client_id'));
		...
		$this->db->where('home_visit',2);
                                                   ...
                                                   <tr ng-show="filteredItems > 0" ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="data.patient_id">
                                                      <td class="text-center" ng-if="data.gender == 'male' || data.gender == 'Male'">
                                                         <!--<img width="40" class="rounded-circle" src="<?php echo base_url() ?>my_assets/assets/images/avatars/boy.png" alt="">-->
                                                         <span ng-if="data.photo">
                                                         <img width="40" class="" src="<?php echo base_url() ?>uploads/patient/<?php echo $rowd->photo;?>">
                                                         </span>
                                                         <span ng-if="data.photo == ''">
                                                         <img width="40" class="rounded-circle" src="<?php echo base_url() ?>my_assets/assets/images/avatars/boy.png" alt="" >
                                                         </span>
                                                         ...
                                                         <?Php $edit = explode(",",$this->session->userdata('edit'));
                                                            if(in_array("1",$edit) || $this->session->userdata('user_login')== false){
                                                            ?>
                                                         <a href="<?php echo base_url().'client/patient/view/' ?><?php echo $rowd->patient_id;?>"> <?php echo $rowd->first_name.''.$rowd->last_name;?></a>
                                                         <?php } else { ?>
                                                         <a>  <?php echo $rowd->first_name.''.$rowd->last_name;?></a>
                                                         <?php } ?>
                                                         <br>
                                                         <div class="badge badge-pill badge-info"><?php echo $rowd->patient_code;?></div>
                                                      </td>
                                                      <td class="text-center" ng-if="data.gender != 'male' && data.gender != 'Male'">
                                                         <!--<img width="40" class="rounded-circle" src="<?php echo base_url() ?>my_assets/assets/images/avatars/girl.png" alt="">-->
                                                         <span ng-if="data.photo">
                                                         <img width="40" class="rounded-circle" src="<?php echo base_url() ?>uploads/patient/<?php echo $rowd->photo;?>">
                                                         </span>
                                                         <span ng-if="data.photo == ''">
                                                         <img width="40" class="rounded-circle" src="<?php echo base_url() ?>my_assets/assets/images/avatars/girl.png" alt="" >
                                                         </span>
                                                      ...
                                                      <td class="text-center text-muted">
                                                        <?php echo $rowd->appoint_date;?>
                                                         <br>
                                                         <a href="https://api.whatsapp.com/send?l=en&phone=91<?php echo $rowd->mobile_no;?>" target="_blank"><img src="<?php echo base_url().'img/whatsapp Logo.png' ?>" style="width:18px; height:18px;" ></img> <?php echo $rowd->mobile_no;?></a>
                                                         <br><span style="white-space: normal; max-width: 150px; overflow: hidden; text-overflow: ellipsis; display: inline-block;"><?php echo $rowd->email;?></span>
                                                      </td>
                                 ...
                                 <div class="col-md-12" ng-controller="customersCrtl">
                                    <div class="table-responsive">
                                       <table class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                             <tr>
                                                <td colspan="3"> <input style="width:100%;" type="text" ng-model="search" ng-change="filter()" placeholder="Search All Fields" class="form-control" /> </td>
                                             </tr>
                                             <tr ng-show="filteredItems > 0" ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="data.patient_id">
                                                <!--<td class="text-center" ng-if="data.gender == 'male' || data.gender == 'Male'">
                                                   <img width="40" class="rounded-circle" src="<?php echo base_url() ?>my_assets/assets/images/avatars/boy.png" alt="">
                                                ...
                                                <td class="text-center" ng-if="data.gender == 'male' || data.gender == 'Male'">
                                                   ...
                                                   <img width="40" class="rounded-circle" src="<?php echo base_url() ?>my_assets/assets/images/avatars/boy.png" alt="" >
                                                      ...
                                                      if(in_array("1",$edit) || $this->session->userdata('user_login')== false){
                                                      ?><a href="<?php echo base_url().'client/patient/view/' ?>{{data.patient_id}}">{{data.first_name}}  {{data.last_name}}</a>
                                                   <?php } else { ?> {{data.first_name}}  {{data.last_name}}
                                                   <?php } ?>
																	<br>
																	<div class="badge badge-pill badge-info">{{data.patient_code}}</div>
                                                </td>
                                    ...
                                    <div class="col-md-12" ng-show="filteredItems > 0">
                                       <div pagination="" page="currentPage" max-size="maxMobSize" on-select-page="setPage(page)" boundary-links="true" total-items="filteredItems" items-per-page="entryLimit" class="pagination-small" previous-text="&laquo;" next-text="&raquo;"></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row mob_none">
