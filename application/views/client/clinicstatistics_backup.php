				 ...
				 <div class='col-md-12'>
					...
					<div class="col-md-5 col-sm-6 col-xs-12 pull-right" style=''>
					 ...
					 <div class="col-md-6 col-sm-6 col-xs-12 " style=''>
						<div class="row">
						<div class="col-md-5">	
						<button class="btn-icon btn-icon-only btn-shadow btn-dashed btn btn-outline-secondary"><a href="<?php echo base_url().'client/settings/index#step-10' ?>"><strong><img src="<?php echo base_url().'images/google_integrate_button.png'?>" style="width:200px; height:40px;"></img></strong></a></button></div>
						<div class="col-md-6 pull-right" style="margin-left: 31px;">
						...
						<!--<img src="<?php echo base_url().'assets/Invite & Earn.png'?>" style="width:45px; height:36px;"></img><a href="<?php echo base_url().'client/dashboard/invite_earn' ?>">--><i class="fas fa-coins fa-2x" style='color:blueviolet;line-height:43px'>&nbsp;&nbsp;Invite & Earn</i></a>
						</div>
						</div>
					</div>
					</div>
					...
					<!--<div class="print col" id="print" style="margin-left: -90px;margin-top:11px;margin-top: -25px;"><div style="float:right;" ><button class="btn-icon btn-icon-only btn-shadow btn-dashed btn btn-outline-secondary"><a href="<?php echo base_url().'client/settings/index#step-10' ?>"><strong><img src="<?php echo base_url().'images/google_integrate_button.png'?>" style="width:200px; height:37px;"></img></strong></a></button></div>
					 ...
					 <div class="print col" id="print"></br><div style="float:right;margin-top: -25px;" ><a href="<?php echo base_url().'client/dashboard/invite_earn' ?>"><strong><img src="<?php echo base_url().'assets/Invite & Earn.png'?>" style="width:45px; height:36px;"></img></strong></a>
														&nbsp;&nbsp;&nbsp;</div>
					 </div>
					 <div class="print col" id="print" style="float:right;display:none;"></br><div style="float:right;" ><a class="btn btn-shadow btn-alternate" href="<?php echo base_url().'client/clinical_summary/report_print' ?>" target="_blank"><strong>Print</strong></a>
														&nbsp;&nbsp;&nbsp;</div>
					 </div>-->
					</div>		
                            ...
                            <ul class="nav nav-justified">
                                ...
                                <li class="nav-item">
                                    <a href="#tab-minimal-1" data-toggle="tab" class="nav-link  minimal-tab-btn-1">
                                        <img src="<?php echo base_url().'iconsforreportsection/patients.png'; ?>" width="45px;" height="50px;">
										<div class="widget-number"><span><?php echo $t4.''.$t1.' Patients';?></span></div>
