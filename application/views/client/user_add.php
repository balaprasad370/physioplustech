...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Add User - Physio Plus Tech</title>
                     ...
                     <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title"> New User</h5>
                                    <form class="" action="<?php echo base_url().'client/user/add_user/' ?>" method="post"  role="form" parsley-validate id="signupForm">
                                         <div class="form-row">
                                            <div class="col-md-6" id="selectbox">
                                                <div class="position-relative form-group"><label for="staff_id" class="">Staff *</label>
												 <select class=" form-control" name="staff_id" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox" id="staff_id">
                                               <option selected="true" disabled="disabled">Please Select</option>    
												<?php
												if ($staff != false) {
													foreach ($staff as $staffs) {
														echo '<option value="'.$staffs['staff_id'].'/'.$staffs['email'].'">'.$staffs['first_name'].'</option>';
													}
												}
											?>
											</select>
											 ...
											 <div class="col-md-6 email_tag" style="display:none;">
											<div class="position-relative form-group"><label for="email" class="">Email</label>
                                                <input type="text" class="form-control email_id" readonly>
												 </div>
                                            </div>
                                        </div>
										<div class="form-row">
                                             <div class="col-md-6">
												...
												<input name="password" placeholder="" type="password" id="password" class="form-control" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" autocomplete="off"></div>
                                            </div>
											<div class="col-md-6">
                                                <div class="position-relative form-group"><label for="confirm_password" class="">Password Confirm *</label>
												<input name="confirm_password" id="confirm_password" type="password" class="form-control" parsley-trigger="change" parsley-required="true" parsley-minlength="6" parsley-type="alphanum" parsley-validation-minlength="1" parsley-equalto="#password" autocomplete="off">
												</div>
                                            </div>
                                        </div>
										<div class="tile-header">
											<h5 class="card-title" style="text-transform:capitalize;">Privilleges</h5>
										</div>
