                                ...
                                <div class="card-body">
								   <div id="smartwizard3" class="forms-wizard-vertical">
                                        <ul class="forms-wizard">
											...
											<li class="nav-item done">
                                                <a href="#step-6">
                                                    <em>7</em><span>Notification</span>
                                                </a>
                                            </li>
											<li class="nav-item done">
                                                <a href="#step-7">
													 ...
													 <div class="custom-checkbox custom-control"><input type="checkbox" id="removebranding" <?php echo ($profile['removebranding']==1 ? 'checked' : '');?> value="1" name="remove_branding" class="custom-control-input"><label class="custom-control-label" for="removebranding"> 
														...
														<label for="youtube" class="col-sm-4 col-form-label">* Youtube URL</label>
														 ...
														 <input name="youtube" id="youtube" type="text" class="form-control" value="<?php echo $profile['youtube'] ?>"></div>
														  ...
														  <div class="position-relative row form-group">
														<label for="youtube" class="col-sm-4 col-form-label">* Instagarm URL</label>
														 <div class="col-sm-8">
														 <input name="instagarm" id="instagarm" type="text" class="form-control" value="<?php echo $profile['instagarm'] ?>"></div>
														  </div>
										...
										<?php } ?>
											...
											<div id="step-6">
                                                <div id="accordion" class="accordion-wrapper mb-3">
													...
													<form class="change_sms" action="<?php echo base_url().'client/settings/change_sms' ?>" method="post"  role="form" parsley-validate>
                                                       ...
                                                       <div class="card-body">
													   <h5 class="card-title" style="text-transform:capitalize;">Whatsapp Notification</h5>
													    <div class="position-relative row form-group">
														<label for="daily_sms_notify" class="col-sm-4 col-form-label">Whatsapp Notification </label>
											  
													 <div class="col-sm-8">
													 <div class="position-relative form-check">
													 <div role="group" class="mb-2 btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
													 
													<label <?php if($profile['whatsapp'] == '1') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
														<input type="radio" name="whatsapp" value="1" id="option1111" autocomplete="off"  <?php echo ($profile['whatsapp']== 1 ? 'checked' : '');?>> Automatic  
													</label>
															
													<label <?php if($profile['whatsapp'] == '2') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
														<input type="radio" name="whatsapp" value="2" id="option1111" autocomplete="off"  <?php echo ($profile['whatsapp']== 2 ? 'checked' : '');?>>   On Trigger
													</label>
																
													<label <?php if($profile['whatsapp'] == '3') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
														<input type="radio" name="whatsapp" value="3" id="option1111" autocomplete="off"  <?php echo ($profile['whatsapp']== 3 ? 'checked' : '');?>> Never
													</label>
											...
											<label for="welcome_sms_notify" class="col-sm-4 col-form-label">SMS Notification for Patients (Welcome to Clinic)</label>
											 ...
											 <div role="group" class="mb-2 btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
                                              ...
                                              <div class="position-relative row form-group">
											<label for="welcome_sms_notify" class="col-sm-4 col-form-label">SMS Notification for Patients (Confirmation Appointment)</label>
											 <div class="col-sm-8">
											 <div class="position-relative form-check">
											 <div role="group" class="mb-2 btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label <?php if($profile['confirm_sms_notify'] == '1') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
                                                        <input type="radio" name="confirm_sms_notify" value="1" id="option111" autocomplete="off"  <?php echo ($profile['confirm_sms_notify']== 1 ? 'checked' : '');?>> Yes
                                                       
                                                    </label>
                                                    <label <?php if($profile['confirm_sms_notify'] == '0') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
                                                        <input type="radio" name="confirm_sms_notify" value="0" id="option122" autocomplete="off" <?php echo ($profile['confirm_sms_notify']== 0 ? 'checked' : '');?>> No
                                              ...
                                              <div class="position-relative row form-group">
											<label for="welcome_sms_notify" class="col-sm-4 col-form-label">SMS Notification for Patients (Rescheduling Appointment)</label>
											 <div class="col-sm-8">
											 <div class="position-relative form-check">
											 <div role="group" class="mb-2 btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label <?php if($profile['reschedul_sms_notify'] == '1') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
                                                        <input type="radio" name="reschedul_sms_notify" value="1" id="option111" autocomplete="off"  <?php echo ($profile['reschedul_sms_notify']== 1 ? 'checked' : '');?>> Yes
                                                       
                                                    </label>
                                                    <label <?php if($profile['reschedul_sms_notify'] == '0') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
                                                        <input type="radio" name="reschedul_sms_notify" value="0" id="option122" autocomplete="off" <?php echo ($profile['reschedul_sms_notify']== 0 ? 'checked' : '');?>> No
                                              ...
                                              <div class="position-relative row form-group">
											<label for="welcome_sms_notify" class="col-sm-4 col-form-label">SMS Notification for Patients (Cancel Appointment)</label>
											 <div class="col-sm-8">
											 <div class="position-relative form-check">
											 <div role="group" class="mb-2 btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label <?php if($profile['cancel_sms_notify'] == '1') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
                                                        <input type="radio" name="cancel_sms_notify" value="1" id="option111" autocomplete="off"  <?php echo ($profile['cancel_sms_notify']== 1 ? 'checked' : '');?>> Yes
                                                       
                                                    </label>
                                                    <label <?php if($profile['cancel_sms_notify'] == '0') echo 'class ="active btn btn-shadow btn-outline-primary"'; else echo 'class = "btn btn-shadow btn-outline-primary"';?>>
                                                        <input type="radio" name="cancel_sms_notify" value="0" id="option122" autocomplete="off" <?php echo ($profile['cancel_sms_notify']== 0 ? 'checked' : '');?>> No
											...
											<div id="step-8">
                                                <div id="accordion" class="accordion-wrapper mb-3">
                                                    <div class="card">
                                                     ...
                                                     <form class="consent_formlist" action="<?php echo base_url().'client/settings/consent_formlist' ?>" method="post"  role="form">
                                    
													<div class="form-group transparent-editor">
													<label class="col-sm-4 control-label">Patient Form :</label>
													<div class="col-sm-8">
													
													  <textarea class="form-control" name="consent_form">
