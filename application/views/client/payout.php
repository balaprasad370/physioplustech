										...
										<div class="col-md-12">
											<div class="main-card mb-3">
												...
												<div class="table-responsive">
													...
													<thead>
													  <tr>
														<th width="58">Settlement Date</th>
														<th width="58">Settlement Curr.</th>
														<th width="92">Amount</th>
														<th width="81">Settlement Mode</th>
														<th width="112">Settled To</th>
													  </tr>
													</thead>
													<tbody>
													<?php foreach($result as $row){ 
														...
														<td> <?php echo 'INR';?></td>
														<td><?php $total = $row['amount'] - $fees - $tax; echo $total; ?></td>
														<td><?php echo 'NEFT'; ?></td>
														<td><?php echo 'VIJAYA BANK'; ?></td>				
														</tr>
														<?php
															} 
														?>
