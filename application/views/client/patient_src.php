...
<html>
 <head>
    ...
    <title>Patient Statistics - Physio Plus Tech</title>
					 ...
					 <div class="row">
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="mb-3 card">
								...
								<div class="card-body"><h5 class="card-title" style="text-transform:capitalize;float:left;">New Patient Entry [Per Day]</h5>
									</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="mb-3 card">
                                <div class="card-header-tab card-header">
								<div class="card-body"><h5 class="card-title" style="text-transform:capitalize;float:left;">Number of Patients Treated Per Day [Derived from session Reporting] </h5>
									</div>
