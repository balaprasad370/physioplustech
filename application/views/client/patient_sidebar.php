          ...
          <div class="app-header-right">
					     <?php
								...
								if($this->session->userdata('is_parent') == 1){
									...
									$query = $this->db->get();
									 if($query->result_array() != false && $query->row()->parent_client_id > 0){
								...
								if($plan != 5){ ?>
						        <div class="btn-group">  
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-shadow btn-wide float-right btn-hover-shine btn" style="background-color: Transparent; border: 1px solid gray; color:white;width:200px;">
                                       <span class="badge badge-pill badge-danger ml-0 mr-1"><?php echo $total_days; ?></span><font color="white"> Days Remaining</font>
										</span>
                                    </a>
								</div>&nbsp;&nbsp;  
								<?php } ?>
				...
				<ul class="header-megamenu nav">
				  ...
				  <ul class="header-megamenu nav">
                    ...
                    <li class="dropdown nav-item">
                        <a aria-haspopup="true"  data-toggle="dropdown" class="nav-link btn btn-shadow btn-warning" aria-expanded="false" style="font-weight:bold;color:black;width:120px;">
