                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
									...
									<?Php $create = explode(",",$this->session->userdata('create'));
										...
										?>
									<div class="col" style="float:right;"></br><div style="float:right;" ><a class="btn btn-shadow btn-warning" href="<?php echo base_url().'client/patient/index' ?>" ><strong>Add New Patient</strong></a>
														&nbsp;&nbsp;&nbsp;</div>
									</div>
									<?php } ?>
									</div> 
											...
											<div class="main-card mb-3" ng-controller="customersCrtl2">
												...
												<td class="text-center" ng-if="data.gender != 'male' && data.gender != 'Male'">
													...
													<span ng-if="data.photo">
															...
															<td class="text-center"><i class="fa fa-business-time"></i>&nbsp;&nbsp;{{data.appoint_date}}</td>
															<td class="text-center text-muted"> 
															<div class="badge badge-pill badge-info">{{data.patient_code}}</div></a>
															</td>
