...
<body>
  <form class="checkout" action="<?php echo base_url() ?>php-sdk/examples/charging-iframe">
	...
	<tr>
	 ...
	 <tr>
		...
		<td>:</td>
		<td><?php echo $profile['zipcode'] ?></td>
	 </tr>
     <?php } ?>
	<tr>
  ...
  <div id="details" style="position: absolute; top: 500px; right: 50px;background-color:orange;text-align:center;width:400px;height:200px;margin-top: 20px;margin-left: 5px;">
