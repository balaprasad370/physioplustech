                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Nist List
									...
									<table class="table table-striped table-bordered">
                                            ...
                                            <tr id="">
                                              <td class="text-center"><?php echo $record['email']; ?></td>
												...
												<a class="edit" href="<?php echo base_url().'nist/admin/nist_print/'.$record['id']; ?>"><button class="mb-2 mr-2 btn-icon btn-icon-only btn-shadow btn-dashed btn btn-outline-success"><i class="fa fa-print"></i></button></a>
