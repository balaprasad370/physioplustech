	 ...
	 <div class="newsletter-area" style="background:#F0FFFF;">
		<div class="container">
			<div class="news-heading text-center">
				  <h5 style="text-align:center;line-height:2;">To Request a quotation based on your usage requirements, </br>kindly fill in the below details and submit the application, </br>we will contact you regarding the pricing for your customized needs</h5>
			</div>
			 
		</div>
	</div>
	
	 	<div id="envelope" style=" padding-bottom: 30px;">
		 <!--<center><h5 style="font-weight: bold;
    padding-bottom: 15px;line-height: 1.5;text-align:center;margin-bottom: .5rem;    margin-top: 0;"></h5></center>-->
<form action="<?php echo base_url().'frontend/request_quote_add'?>" method="post" id="mailForm">
...
<input name="name" placeholder="Your Name" type="text" width="100px;" id="name">
<div id="invalid-name" class="error_msg"></div>
<label><b>Email Id :</b></label>
<input name="email" placeholder="your Email" type="text" id="email">
<div id="invalid-email" class="error_msg"></div>
<label><b>Mobile No :</b></label>
<input name="mobile" placeholder="Your Mobile No" type="text" id="mobile">
<div id="invalid-mobile" class="error_msg"></div>
<label><b>Requirements</b></label><br>
<input type="checkbox" name="req[]" value="Appointment-scheduling" id="req"><font size="4px">  Appointment scheduling<br><br>
<input type="checkbox" name="req[]" value="Billing" id="req"> Billing<br><br>
<input type="checkbox" name="req[]" value="Physiotherapy-Assesments-Documentation" id="req"> Physiotherapy Assesments and Documentation<br><br>
<input type="checkbox" name="req[]" value="Generate-Printable-reports" id="req"> Generate Printable reports<br><br>
<input type="checkbox" name="req[]" value="Exercise-Prescription" id="req"> Exercise Prescription <br><br>
<input type="checkbox" name="req[]" value="Mobile-app" id="req"> Customized mobile app for your clinic in android app store<br><br>
<input type="checkbox" name="req[]" value="Staff Management" id="req"> Staff Management<br><br>
<!--<input type="checkbox" name="req[]" value="Staff-login"> No Of Staff logins Required<br><br>
<input type="checkbox" name="req[]" value="Clinic-location"> No Of Clinic locations Required<br><br>-->
<div id="invalid-req" class="error_msg"></div>
<label><b>Number Of Staff Logins Required :</b></label>
<input name="login" placeholder="Number Of Staff Logins" type="text" id="login">
<div id="invalid-login" class="error_msg"></div>
<label><b>Number Of Clinic locations Required :</b></label>
<input name="clogin" placeholder="Number Of Clinic locations" type="text" id="clogin">
<div id="invalid-clogin" class="error_msg"></div>
<!--<input type="checkbox" name="req[]" value="Car"> Duration Of License</font><br><br>-->
<!--<label><b>Duration :</b></label>
<select name="duration" id="duration" required>
<option selected="true" disabled="disabled">Select Duration</option>
<option value="6-months">6 Months</option>
<option value="1-year">1 Year</option>
</select>-->
<label><b>Duration</b></label><br>
<input type="radio" name="duration" value="6-months" id="duration">  6 Months<br><br>
<input type="radio" name="duration" value="1-year" id="duration">  1 Year<br><br>
<div id="invalid-duration" class="error_msg"></div>
<label><b>Message :</b></label>
<textarea cols="15" name="desc" placeholder="Short description about your requirements" rows="10" id="desc">
</textarea>
<div id="invalid-desc" class="error_msg"></div>
