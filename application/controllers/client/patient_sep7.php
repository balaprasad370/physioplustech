...
class Patient extends CI_Controller {
	...
	public function treatmentTechniquereschedule(){
		...
		$this->db->select('ti.staff_id,ti.treatment_quantity,ti.no_of_days,ti.treatment_price,ti.treatments,it.item_name')->from('tbl_patient_treatment_techniques ti');
		...
		foreach($res->result_array() as $row){
            ...
            array_push($arr4,$row['no_of_days']);
		}
