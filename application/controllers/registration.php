...
class Registration extends CI_Controller {
	...
	function google_validate_captcha() {
		...
		$google_response = file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LdJzJkaAAAAAOAKFOTQu6R_bkFFSNl4xTMOLjtH&response=" . $google_captcha . "&remoteip=" . $_SERVER['REMOTE_ADDR']);
