 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'intechkishore_api1.gmail.com' : 'contact_api1.physioplusnetwork.com';
$config['APIPassword'] = $config['Sandbox'] ? '52UHB8YP7NXX78N3' : 'G9RHMFGD5S8NS7JY';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31Adu7KyzBLbkadBhrkWiyBx1nu.HQ' : 'APu34t2wm9Gn-LiS34JOej-FaJ3nAoacuIEwqXegbPFAYf2BHOL7VZEp';
